...
public class UsuarioController implements IUsuarioController {
    ...
    public String login(String username, String contrasena) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                usuario usuarios = new usuario(propietario, email, usuario, pass);
    ...
    @Override
    public String register( String names, String email, String username, String contrasena) {

        Gson gson = new Gson();

        DBConnection con = new DBConnection();
        String sql = "Insert into tb_usuarios values('" + names
        ...
        try {
            ...
            usuario usuarios = new usuario(names, email, username, contrasena);
